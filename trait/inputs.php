...
trait inputs {
    ...
    public static function get(...$args) {
        switch ( count($args) ) {
            case 2:
                return Input::instance()->get($args[0], $args[1]);
    ...
    public static function post(...$args) {
        switch ( count($args) ) {
            case 2:
                return Input::instance()->post($args[0], $args[1]);
    ...
    public static function server(...$args) {
        switch ( count($args) ) {
            case 2:
                return Input::instance()->server($args[0], $args[1]);
    ...
    public static function request(...$args) {
        switch ( count($args) ) {
            case 2:
                return Input::instance()->request($args[0], $args[1]);
    ...
    public static function files(...$args) {
        switch ( count($args) ) {
            case 2:
                return Input::instance()->files($args[0], $args[1]);
