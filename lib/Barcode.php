...
class Barcode {
    ...
    protected $_encode; // You should prefer string over integers to avoid bugs when value start with 0
    protected $_error = '';
    protected $_width = 0;
    ...
    public function __construct($encoding, $font_path) {
    ...
    public function setSymblogy($encoding) {
    ...
    public function genBarCode($barnumber, $file = null) {
        $this->_file = $file;
    ...
    /// Start public function for code93
    ...
    public function _c93Barcode($barnumber, $checkdigit = false) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    /// Start public function for code39
    ...
    public function _c39Barcode($barnumber, $checkdigit = false) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    ///Start public function for code128
    ...
    public function _c128Barcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    ///End public function for codabar
    ///Start public function for codabar
    ...
    public function _codaBarcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    ///End public function for codabar
    // Start public function for POSTNET
    /*
    ...
    public function _postBarcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    // End public function for POSTNET
    // Start public function for INTERLEAVED
    ...
    public function _i25Barcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    // End public function for INTERLEAVED
    // Start public function for S2O5
    ...
    public function _so25Barcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    public function _upceBarcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    public function _ean8Barcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
    ...
    public function _eanBarcode($barnumber) {
        $scale = $this->_scale;
        $file = $this->_file;
